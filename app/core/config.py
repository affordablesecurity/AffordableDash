...
class Settings(BaseSettings):
    ...
    # JWT cookie used for both Web + API
    auth_cookie_name: str = os.getenv("AUTH_COOKIE_NAME", "affordablecrm_auth")

    # Active location cookie (web UI convenience)
    active_location_cookie_name: str = os.getenv("ACTIVE_LOCATION_COOKIE_NAME", "affordablecrm_location_id")
